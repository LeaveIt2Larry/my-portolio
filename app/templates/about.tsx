      ...
      <section className='relative mt-24 flex grid-cols-12 flex-col-reverse gap-y-10 md:ml-24 md:grid md:gap-x-8 lg:gap-x-16'>
        <section className='col-span-full md:col-span-6 xl:col-span-8'>
          ...
          >
            ...
            <AnimatedText
              as='p'
              text="Hey, I'm Larry and I'm a developer from California."
              className='text-dark-400 dark:text-dark-200 mt-6 text-lg font-light leading-relaxed'
            />
            <AnimatedText
              as='p'
              text="I think the frontend experience for the user is key to the success of a product and I've had a lot of fun improving my practice in this area."
              className='text-dark-400 dark:text-dark-200 mt-6 text-lg font-light leading-relaxed'
            />
            <AnimatedText
              as='p'
          ...
          >
            ...
            >
              ...
              <SiReact size={28} title='React.tsx' />
              <SiNextdotjs size={28} title='Next.tsx' />
        ...
        >
          <MotionImage
            ...
            fill
            quality={100}
            src='/larry/LarryProfileNobg.png'
